...
const { joi, validations, namePattern, caseInsensitiveComparator } = validationsDefault
...
const completeSchema = joi.object({
  ...
  userSpecifiedRelocationType: joi.when('relocationCompliancy', {
    is: false,
    then: joi.when('relocationType', {
      is: 'OTHER',
