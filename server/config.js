...
module.exports = {
  ...
  apis: {
    oauth2: {
      ...
      systemClientId: get('SYSTEM_CLIENT_ID', get('API_CLIENT_ID', 'use-of-force-client'), requiredInProduction),
      systemClientSecret: get('SYSTEM_CLIENT_ID', get('API_CLIENT_SECRET', 'clientsecret'), requiredInProduction),
    },
    elite2: {
