...
export interface components {
  schemas: {
    ...
    Location: {
      ...
      /** @description Pending capacity details of draft or pending approval locations */
      pendingCapacity?: components['schemas']['Capacity']
      /**
       * Format: int32
    ...
    LevelAboveCells: {
       ...
       * @enum {string}
       */
      locationType: 'WING' | 'SPUR' | 'LANDING' | 'CELL'
    }
    NewCellRequest: {
      /**
       * @description Code of the location
