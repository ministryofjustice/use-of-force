...
beforeEach(() => {
  ...
  reportingService.getMostOftenInvolvedStaff.mockResolvedValue('Some,Csv,Content')
})
...
describe('GET /reports/mostOftenInvolvedStaff/:agencyId/:year/:month', () => {
  it('should render for reviewer', async () => {
    ...
    await request(app)
      ...
      .expect('Content-Disposition', `attachment; filename="LEI-10-2019.csv"`)
      .expect(res => {
        expect(res.text).toContain('Some,Csv,Content')
      })
