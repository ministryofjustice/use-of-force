...
beforeEach(() => {
  ...
  userElite2ClientBuilder.mockReturnValue(elite2Client)

  service = serviceCreator({ incidentClient, userElite2ClientBuilder, involvedStaffService, notificationService, db })
