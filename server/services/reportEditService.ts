...
export default class ReportEditService {
  ...
  mapReasonToTitleAndText(data) {
    switch (data.reason) {
      ...
      case REASON.BODY_CAM_FOOTAGE_REAVELED_INVOLVED:
        return REASON.BODY_CAM_FOOTAGE_REAVELED_INVOLVED_DESCRIPTION

      case REASON.FORGOTTEN_IN_REPORT:
        return REASON.FORGOTTEN_IN_REPORT_DESCRIPTION

      case REASON.FOOTAGE_REAVELED_NOT_INVOLVED:
        return REASON.FOOTAGE_REAVELED_NOT_INVOLVED_DESCRIPTION

      case REASON.PERSON_ADDED_IN_ERROR:
        return REASON.PERSON_ADDED_IN_ERROR_DESCRIPTION
